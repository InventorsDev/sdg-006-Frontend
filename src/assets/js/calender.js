var Calendar = function(t) {
    this.divId = t.RenderID ? t.RenderID : '[data-render="calendar"]', this.DaysOfWeek = t.DaysOfWeek ? t.DaysOfWeek : ["S", "M", "T", "W", "T", "F", "S"], this.Months = t.Months ? t.Months : ["Jan", "Feb", "Mar", "April", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"];
    var e = new Date;
...
Calendar.prototype.nextMonth = function() {
    ...
    var r = (new Date).getDate(),
        ...
        s = "<span>" + this.Months[e] + " &nbsp; " + "" + "</span>", //t in place of ""
        d = '<div class="table">';
